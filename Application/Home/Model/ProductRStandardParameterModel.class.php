...
'id' => $id,
	...
	// 获取图片管理表中分页数据
	public function searchByPage($product_id,$standard_id,$standard_parameter_id,$create_time, $pageindex, $pagesize) {
		$result = new PageDataResult ();
		$lastpagenum = $pageindex * $pagesize;
		$conn = new Pdo ();
		$objects = $conn->query ( " select id,product_id,standard_id,standard_parameter_id,create_time from gogojp_product_r_standard_parameter where  ( product_id = :product_id or :product_id=0 ) 
 and  ( standard_id = :standard_id or :standard_id=0 ) 
 and  ( standard_parameter_id = :standard_parameter_id or :standard_parameter_id=0 ) 
...
':product_id' => $product_id,
		...
		$data = $conn->query ( " select count(*) totalcount  from gogojp_product_r_standard_parameter where  ( product_id = :product_id or :product_id=0 ) 
 and  ( standard_id = :standard_id or :standard_id=0 ) 
 and  ( standard_parameter_id = :standard_parameter_id or :standard_parameter_id=0 ) 
 and  ( create_time = :create_time or :create_time='' ) 
", array (
