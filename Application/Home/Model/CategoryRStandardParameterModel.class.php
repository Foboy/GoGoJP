...
'id' => $id,
	...
	public function searchByPage($standard_id,$parameter_id,$category_id,$create_time, $pageindex, $pagesize) {
		...
		$conn = new Pdo ();
		$objects = $conn->query ( " select id,standard_id,parameter_id,category_id,create_time from gogojp_category_r_standard_parameter where  ( standard_id = :standard_id or :standard_id=0 ) 
